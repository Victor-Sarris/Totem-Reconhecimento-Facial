...
# --- CLASSE DE CAPTURA DE VÍDEO (BUFFERIZADO) ---
class VideoStream:
...
def loop_reconhecimento():
    ...
    # Comandos para forçar tela cheia no Linux/Labrador
    ...
    while True:
        try:
            ...
            # Se apertar ESC (27) ou 'q', sai da tela cheia
